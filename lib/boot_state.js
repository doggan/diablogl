...
class BootState {
    ...
    _onMapFinishedLoading() {
        ...
        this._player = new Player(this.objectGroup);
        let pos = this._map.tileToWorldPosCenter([0, 0]);
        this._player.sprite.position.set(pos[0], pos[1]);
    ...
    update() {
        ...
        this._player.update(dt, this.cursors);
